...
3. **Configure Extension Settings:**
   ...
   |---------|-------|-------------|
   | **Vacation Agent: Project Path** | `/absolute/path/to/vacation_agent` | Full path to this repository |
   | **Vacation Agent: Python Path** | `python` or `python3` | Your Python executable path |
   | **Vacation Agent: OpenAI API Key** | Your API key (optional) | Or set `OPENAI_API_KEY` env var |

   **Example Configuration:**
   ```
   Project Path: /mnt/c/Users/racel/github/vacation_agent/agents
   Python Path: python
   ...
   **Alternative: Edit settings.json directly:**
   ...
   ```json
   {
     "vacationAgent.projectPath": "/mnt/c/Users/racel/github/vacation_agent/agents",
     "vacationAgent.pythonPath": "python",
...
4. Use forward slashes: `/mnt/c/Users/racel/github/vacation_agent`
